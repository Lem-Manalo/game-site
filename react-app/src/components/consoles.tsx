...
function Consoles() {
  let image: string = "PS5";
  const [activeImage, setActiveImage] = useState(image);

  const handleSvgClick = (image: string) => {
  ...
  return (
    <section className="console-sec flex flex-col items-center relative z-40 bg-gradient-to-b from-black via-gray-900 to-gray-800">
      <div className="flex justify-center space-x-8 lg:space-x-24 items-center py-8 px-4">
        <svg onClick={() => handleSvgClick("PS5")} className="transition-transform duration-500 transform w-8 md:w-16 h-auto hover:cursor-pointer hover:translate-y-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" fill="#ffffff">
        ...
        <svg onClick={() => handleSvgClick("Xbox")} className="transition-transform duration-500 transform w-8 md:w-16 h-auto hover:cursor-pointer hover:translate-y-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256" fill="#ffffff">
        ...
        <svg onClick={() => handleSvgClick("Nintendo Switch")} className="transition-transform duration-500 transform w-8 md:w-16 h-auto hover:cursor-pointer hover:translate-y-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256" fill="#ffffff">
        ...
        <svg onClick={() => handleSvgClick("Steamdeck")} className="transition-transform duration-500 transform w-8 md:w-16 h-auto hover:cursor-pointer hover:translate-y-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256" fill="#ffffff">
      ...
      <div className={activeImage == "PS5" ? "" : "hidden"}>
      ...
      <div className={activeImage == "Xbox" ? "" : "hidden"}>
      ...
      <div className={activeImage == "Nintendo Switch" ? "" : "hidden"}>
      ...
      <div className={activeImage == "Steamdeck" ? "" : "hidden"}>
